...
let count = Math.floor((styles.length - 1) / 2);
...
class Calculator {
  ...
  calculate(str) {
    ...
    this.operat = this.split[1];
    this.number2 = +this.split[2];

    if (isNaN(this.number1) || isNaN(this.number2) || !this.operat) {
      return NaN;
    }

    return this.method[this.operat](this.number1, this.number2);
  }
